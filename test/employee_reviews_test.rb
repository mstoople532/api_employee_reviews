...
class EmployeeReviews < Minitest::Test
  ...
  def test_total_department_salary
    ...
    assert_equal 90_000.00, a.department_salary
  end
  ...
  def test_give_raise_by_percent
    new_employee = Employee.new(name: "Dan", email: "d@mail.com", phone: "914-555-5555", salary: 50_000.00)
    assert_equal 54_000, new_employee.raise_by_percent(0.08)
  end
  ...
  def test_department_raises_based_on_criteria
    ...
    new_employee.set_employee_performance(true)
    old_employee.set_employee_performance(false)
    a.department_raise(14_000.00) { |e| e.satisfactory == true && e.salary < 60_000.00 }
    assert_equal 70_000.00, xavier.salary
    assert_equal 64_000.00, new_employee.salary
    assert_equal 40_000.00, old_employee.salary
  end
